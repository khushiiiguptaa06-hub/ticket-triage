...
def test_valid_ticket_creates_id_and_timestamp() -> None:
...
def test_title_too_short_raises_validation_error() -> None:
    with pytest.raises(Exception):
        Ticket(title="Hi", description="Too short")


def test_whitespace_stripped_automatically() -> None:
